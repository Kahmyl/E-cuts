	<main id="main" class="main-site">
		...
		<div class="container">
			...
			<div class=" main-content-area">
					...
					<ul class="products-cart">
						...
						<li class="pr-cart-item">
							<div class="product-image">
								<figure><img src="{{ ('rss/img/products')}}/{{$item->model->image}}" alt="{{$item->model->name}}"></figure>
							</div>
				...
				<div class="summary">
					<div class="order-summary">
						...
						@if (Session::has('coupon'))
							...
							<p class="summary-info"><span class="title">Subtotal(discount)</span><b class="index">${{$subtotalAfterDiscount}}</b></p>
							<p class="summary-info"><span class="title">Custom fees ({{config('cart.tax')}}%) </span><b class="index">${{$taxAfterDiscount}}</b></p>
							<p class="summary-info total-info"><span class="title">Total</span><b class="index">${{$totalAfterDiscount}}</b></p>
						@else
						    <p class="summary-info"><span class="title">Custom fees</span><b class="index">{{Cart::tax()}}</b></p>
					...
					@if(!Session::has('coupon'))
					    <div class="checkout-info">
					    	<label class="checkbox-field">
					    		<input class="frm-input " name="have-code" id="have-code" value="1" type="checkbox" wire:model="haveCouponCode"><span>Add a coupon</span>
					    	</label>
					    	@if ($haveCouponCode == 1)
					    	    <div class="summary-item">
					    	    	<form action="" wire:submit.prevent="applyCouponCode">
					    	    		...
					    	    		<p class="row-in-form">
					    	    			...
					    	    			<input type="text" name="couponCode" wire:model='couponCode'>
					    	    		</p>
				...
				<div class="wrap-iten-in-cart">
					<h4 class="title-box" style="border-bottom: 1px solid #aaa; padding-bottom:15px; padding-top:25px;">{{Cart::instance('saveForLater')->count()}} Item(s) Saved For Later</h3>
					...
					@else
					     <p>No item has been saved for later</p>	
					@endif
				</div>
