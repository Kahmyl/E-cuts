                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                          <ul class="slides">
                            ...
                            <li data-thumb="{{asset('rss/img/products') }}/{{$product->image}}">
                                <img src="{{asset('rss/img/products') }}/{{$product->image}}" alt="{{$product->name}}">
                            </li>
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-social">
                            <a class="link-socail" href="#"><img src="{{ asset('rss/img/social-list.png') }}" alt=""></a>
                        </div>
                                        ...
                                        <ol class="commentlist">
                                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                <div id="comment-20" class="comment_container"> 
                                                    <img alt="" src="{{asset('rss/img/author-avata.jpg') }}" height="80" width="80">
                                ...
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{route('product.details', ['slug'=>$p_product->slug])}}" title="{{$p_product->name}}">
                                            <figure><img src="{{ asset('rss/img/products') }}/{{$p_product->image}}" alt="{{$p_product->name}}"></figure>
                                        </a>
                                    </div>
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('product.details', ['slug'=>$r_product->slug])}}" title="{{$r_product->name}}">
                                        <figure><img src="{{ asset('rss/img/products') }}/{{$r_product->image}}" width="214" height="214" alt="{{$r_product->name}}"></figure>
                                    </a>
